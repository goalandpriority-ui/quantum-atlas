...
export const processors: QuantumProcessor[] = [
  ...
  },
  {
    ...
    qubitCount: 2,
    connectivity: "Linear",
    gateTypes: ["Single-qubit", "Two-qubit (CZ)"],
    summary: "Alice & Bob's cat qubit processor uses bosonic cat states to dramatically suppress one type of error (bit flips) by design, potentially requiring fewer physical qubits per logical qubit than surface code implementations.",
    strengths: ["Inherent bit-flip suppression", "Potentially lower qubit overhead", "Room temperature control electronics possible"],
    limitations: ["Phase flip errors still require correction", "Early prototype stage", "Limited qubit count"],
    cloudAccess: false,
  ...
  },
  {
    ...
    year: "2022",
    qubitType: "Neutral atoms (Rydberg)",
    qubitCount: 256,
    connectivity: "Programmable, reconfigurable",
    gateTypes: ["Single-qubit", "Two-qubit (Rydberg CZ)", "Analog mode"],
    summary: "QuEra's Aquila processor uses neutral rubidium atoms arranged in reconfigurable 2D arrays, achieving 256 qubits with programmable connectivity and both analog and digital operation modes.",
    strengths: ["256 qubits", "Reconfigurable connectivity", "Analog simulation mode", "Available via Amazon Braket"],
    limitations: ["Gate fidelity still improving vs trapped-ion", "Shot-to-shot variability", "Relatively new platform"],
    cloudAccess: true,
    status: "Commercially available (AWS Braket)",
  },
  {
    slug: "diraq-core1",
    name: "Diraq CORE1",
    company: "Diraq",
    year: "2023",
    qubitType: "Silicon spin qubits (CMOS)",
    qubitCount: 4,
    connectivity: "Linear",
    gateTypes: ["Single-qubit", "Two-qubit (exchange)"],
    summary: "Diraq's CORE1 is a silicon spin qubit processor fabricated using standard CMOS processes — the same manufacturing technology used for classical chips — offering a potential path to manufacturing scale.",
    strengths: ["CMOS compatible manufacturing", "Long coherence times", "Scalability potential via existing semiconductor fabs"],
    limitations: ["Very low qubit count", "Cryogenic operation required", "Long-term scaling unproven"],
    cloudAccess: false,
    status: "Research prototype",
  },
  {
    slug: "riken-h60",
    name: "RIKEN 64-Qubit Superconducting Processor",
    company: "RIKEN / Fujitsu",
    year: "2023",
    qubitType: "Superconducting transmon",
    qubitCount: 64,
    connectivity: "2D grid",
    gateTypes: ["Single-qubit", "Two-qubit (CZ, iSWAP)"],
    summary: "Japan's first domestically developed and cloud-accessible superconducting quantum computer, operated by RIKEN in partnership with Fujitsu, targeting a 1000-qubit successor by 2026.",
    strengths: ["First domestic Japanese cloud-accessible QC", "Strong institutional backing", "Roadmap to 1000 qubits"],
    limitations: ["Lower qubit count than leading US/EU processors", "Benchmark results limited", "Access primarily for Japanese research institutions"],
    cloudAccess: true,
    status: "Cloud accessible (Japan research network)",
  },
  {
    slug: "ntt-photonic",
    name: "NTT Coherent Ising Machine",
    company: "NTT",
    year: "2019",
    qubitType: "Photonic (optical parametric oscillators)",
    qubitCount: 100000,
    connectivity: "All-to-all (via measurement feedback)",
    gateTypes: ["Ising model optimization (analog)"],
    summary: "NTT's Coherent Ising Machine uses optical parametric oscillators in a fiber loop to solve Ising model optimization problems — a specialized analog approach distinct from gate-based quantum computing.",
    strengths: ["100,000+ spin equivalents", "All-to-all connectivity via feedback", "Room temperature operation", "Fast sampling"],
    limitations: ["Not a universal gate-based quantum computer", "Limited to Ising-type optimization", "No quantum error correction"],
    cloudAccess: true,
    status: "Available (NTT cloud platform)",
  },
  {
    slug: "iqm-garnet",
    name: "IQM Garnet",
    ...
    qubitType: "Superconducting transmon",
    qubitCount: 20,
    connectivity: "2D square lattice",
    gateTypes: ["Single-qubit", "Two-qubit (CZ)"],
    summary: "IQM's Garnet is a 20-qubit superconducting processor deployed at VTT (Finland's national quantum computer) and sold to European research institutions, representing Europe's leading domestic superconducting quantum hardware.",
    strengths: ["European domestic hardware", "Delivered to real customers", "Strong two-qubit gate fidelity", "On-premise deployment model"],
    limitations: ["20 qubits — smaller than US leaders", "No public cloud access", "Smaller ecosystem than IBM/Google"],
    cloudAccess: false,
    status: "Deployed (Finland, Germany, Spain)",
  },
];
