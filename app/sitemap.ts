...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: "/qubit-defender", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/learning-paths", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/learn/quiz-hub", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/learn/superposition-visual", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/learn/entanglement-visual", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/learn/interference-visual", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/interview-questions", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/roadmap", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/frameworks", priority: 0.8, changeFrequency: "monthly" as const },
    { url: "/certification", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/certification/exam", priority: 0.8, changeFrequency: "monthly" as const },
